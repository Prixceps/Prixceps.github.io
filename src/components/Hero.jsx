      ...
      <div className="max-w-[90rem] mx-auto px-6 sm:px-12 lg:px-16 relative z-10 w-full">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm font-medium text-gray-400 tracking-widest uppercase">Prince Raj</span>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-12 border-t border-white/10 pt-12">
          <div className="flex flex-col gap-8">
            ...
            >
              I build <span className="text-white">AI-powered applications</span> and scalable web solutions that are performant, intelligent, and designed to make an impact.
            </motion.p>
